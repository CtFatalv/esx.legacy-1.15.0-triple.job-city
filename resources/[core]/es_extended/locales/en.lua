return {
    ...
    ["command_refreshitems"] = "Recharger tous les objets depuis la base de données.",
    ["command_refreshitems_success"] = "%d objets rechargés avec succès.",
