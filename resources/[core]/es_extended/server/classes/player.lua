...
---@field job2 ESXJob                # Player's current job.
---@field job3 ESXJob                # Player's current job.
...
function CreateExtendedPlayer(playerId, identifier, ssn, group, accounts, inventory, weight, job, job2, job3, loadout, name, coords, metadata)
    ...
    function self.setJob2(newJob2, grade2, onDuty)
        ...
        self.job2 = {
            ...
            skin_male = decodeJobSkin(grade2Object.skin_male),
            skin_female = decodeJobSkin(grade2Object.skin_female),
        }
    ...
    function self.setJob3(newJob3, grade3, onDuty)
        ...
        self.job3 = {
            ...
            skin_male = decodeJobSkin(grade3Object.skin_male),
            skin_female = decodeJobSkin(grade3Object.skin_female),
        }
