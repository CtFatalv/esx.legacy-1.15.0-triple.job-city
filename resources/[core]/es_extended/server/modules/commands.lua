...
ESX.RegisterCommand(
    "setjob2",
    FilterGroups(CommandPermissions.setjob2),
    function(xPlayer, args, showError)
...
ESX.RegisterCommand(
    "setjob3",
    FilterGroups(CommandPermissions.setjob3),
    function(xPlayer, args, showError)
...
ESX.RegisterCommand("job2", FilterGroups(CommandPermissions.job2), function(xPlayer, _, _)
...
ESX.RegisterCommand("job3", FilterGroups(CommandPermissions.job3), function(xPlayer, _, _)
...
ESX.RegisterCommand("info2", FilterGroups(CommandPermissions.info2), function(xPlayer)
...
ESX.RegisterCommand("info3", FilterGroups(CommandPermissions.info3), function(xPlayer)
