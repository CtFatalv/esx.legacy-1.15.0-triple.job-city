...
Config.Weather = {
    ...
    RealWeather = { --If you chose 'real', you have the following configurable options:
        city = 'Paris', --The city from which you want to fetch the weather, e.g., London, Miami, Dubai, or Paris.
...
Config.Time = {
    ...
    RealTime = { --If you chose 'real', you have the following configurable options:
        city = 'Paris', --The city from which you want to fetch the time, e.g., London, Miami, Dubai, or Paris.
